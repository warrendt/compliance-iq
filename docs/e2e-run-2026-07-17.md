...
- Backend revision under test: `<backend-revision>`
- Signed in as: `<operator>@<tenant>.onmicrosoft.com` (Easy Auth, ARM token in store)
...
Three resources created in subscription `<subscription-name>`, all
