...
[![Compliance](https://img.shields.io/badge/Frameworks-7%20Supported-green)](#supported-frameworks)
...
| **Saudi Arabia Government** | Saudi Arabia | Government | 58 | [View](catalogues/Saudi_Arabia_Government_Azure_Mappings.csv) || **NDMO Data Management** | Saudi Arabia | Government | 38 | [View](reference_documents/ndmo/NDMO_Azure_Controls_Mapping.md) |
| **NCA CSCC v1.5** | Saudi Arabia | Government / CNI | 49 | [View](reference_documents/nca/NCA_CSCC_to_Azure_Policy_Mapping.md) || **South African Government** | South Africa | Government | 56 | [View](catalogues/South_African_Government_Azure_Mappings.csv) |
